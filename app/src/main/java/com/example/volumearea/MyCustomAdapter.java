...
public class MyCustomAdapter extends ArrayAdapter<Shape> {
    ...
    Context context; //current state and environment of the application
    ...
    //View Holder:Used to cache references to the vies within an item layout
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            LayoutInflater inflater=LayoutInflater.from(getContext());//it is a utility class used to instantiate xml layout file
                                                            //and convert them into corresponding objects (inflate at runtime)
